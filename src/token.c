...
TokenCode TS_DIRECTIVE[] = { AS_CODE_OPERATOR_DOT, TC_NULL };
TokenCode TS_DIRECTIVE_ARG[] = { AS_CODE_IMMEDIATE, AS_CODE_WORD, TC_NULL };
TokenCode TS_DIRECTIVE_ARGS[] = { AS_CODE_WORD, TC_NULL };
TokenCode TS_DIRECTIVE_NAME[] = { AS_CODE_WORD, TC_NULL };
...
TokenCode TS_PREFIX[] = { AS_CODE_WORD, TC_NULL };
